 ...
 */
public  class RecycAdapter extends RecyclerView.Adapter<RecycAdapter.WidgetHolder>{

    private Context mContext;
    private List<WidgetBean> mDatas;

    public RecycAdapter(Context mContext, List<WidgetBean> mDatas) {
    ...
    public void onBindViewHolder(final WidgetHolder holder, final int position) {
        WidgetBean widgetBean = mDatas.get(position);
        holder.mTvItemName.setText(widgetBean.mTvItemName);
